...
public class TextUtil {
    ...
    public static final String VERSION = PixelmonMDK.VERSION;

    private static final IFormattableTextComponent PLUGIN_PREFIX = new StringTextComponent(Util.formattedString(PixelmonMDK.languageConfig.prefix)).setStyle(Style.EMPTY.setColor(BLUE));

    private static final IFormattableTextComponent MESSAGE_PREFIX = getPluginPrefix().appendSibling(new StringTextComponent(PixelmonMDK.languageConfig.splitter).setStyle(Style.EMPTY.setColor(ORANGE)));
